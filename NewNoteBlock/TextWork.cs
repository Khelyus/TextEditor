...
namespace NewNoteBlock
{
    ...
    public static class TextWork
    {
        ...
        private static int findcutlength;
        public static int GetFindCutLength()
        {
            return findcutlength;
        }


        public static int AnotherFindTextBox(ref TextBox textBox, string findText, ref int findCutLength, bool register)
        {
            ...
            if (register == true)
            {
                if (textBox.Text.Contains(findText))
                {
                    ...
                    int resultPosition = nextText.LastIndexOf(findText);
                    ...
                    {
                        findCutLength = 0;
                        return AnotherFindTextBox(ref textBox, findText, ref findCutLength, register);
                    }
                }
                else
                {
        ...
        public static void mEditEnableds(ref TextBox notebox, ref ToolStripMenuItem MenuCopy, ref ToolStripMenuItem MenuCut, ref ToolStripMenuItem MenuDelete, ref ToolStripMenuItem MenuReplace, ref ToolStripMenuItem MenuGoOver)
        {
